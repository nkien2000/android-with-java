...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 15, 2021 lúc 01:19 AM
...
(7, 22, 42, 'Laptop HP Envy 13 ad158TU i5 8250U/4GB/128GB/Win10/(3MR80PA)', 19990000, 1);
...
(3, 'Máy Ảnh', 'https://image.flaticon.com/icons/png/512/83/83574.png');
...
(40, 'Máy ảnh Ricoh WG-70/ Đen', 6500000, 'https://kyma.vn/thumb/images/product/may-anh-pentax-ricoh-wg-70(1).jpg', '- Cảm biến: CMOS 16.0 megapixels\n- Màn hình: LCD 2.7inch\n- Zoom Quang học: 5x (28-140mm) Zoom số 7.2x\n- Khẩu độ: F/3.5(W) - F/5.5(T)\n- Độ nhạy sáng: ISO 125-6400\n- Tốc độ màn trập: 1/4- 1/4000 giây\n- Tốc độ chụp: 4 ảnh/ giây \n- Quay phim: Full HD(1920 x1080) 30fps\n- Chế độ kính hiển vi kỹ thuật số\n- Chống nước: 14m, chống lạnh -10°C, chống sốc 1.6m, chống bụi\n- Tích hợp: Wifi \n- Pin tương thích: Li-92\n- Trọng lượng: 173g\n- Phụ kiện đi kèm: Pin, Adapter, Dây đeo, Cáp USB, Cataloge, Phiếu bảo hành', 3),
...
(43, 'Máy ảnh Fujifilm Instax Mini 11 Blush Pink/ Hồng', 1999000, 'https://kyma.vn/thumb/images/product/may-anh-fujifilm-instax-mini-11-blush-pink-hong.jpg', '- Phim ảnh: Bộ phim tức thời mini Fujifilm INSTAX\r\n- Ảnh cỡ: 62mm x 46mm\r\n- Ống kính: 2 thành phần, 2 yếu tố, f = 60mm, 1: 12,7\r\n- Kính ngắm: Công cụ tìm hình ảnh thực, 0,37x, với vị trí mục tiêu\r\n- Màn trập: Màn trập điện tử được lập trình1 / 2 đến 1/250 giây. Synchro chậm cho ánh sáng yếu\r\n- Kiểm soát tiếp xúc: Tự động, Lv 5.0 đến 14,5 (ISO 800)', 3),
(44, 'Máy ảnh Canon Ixus 185/ Đen', 1459000, 'https://kyma.vn/thumb/images/product/canon-ixus-185-den(1).jpg', '- Cảm biến: CCD 20 megapixels \n- Bộ xử lý hình ảnh: Digic 4+\n- Màn hình: 2.7inch \n- Zoom quang học 8x (28-224mm) ZoomPlus 16x\n- Khẩu độ: F/3.0- F/9.0 (W), F/6.9- F/20.0 (T)\n- Độ nhạy sáng: ISO 100-800\n- Tốc độ màn trập: 15 - 1/2000 giây\n- Tốc độ chụp: 0,8 ảnh/ giây (ở chế độ Auto, chế độ P)\n- Quay phim: HD \n- Pin tương thích: NB-11LH\n- Trọng lượng: 111g\n- Phụ kiện đi kèm: Pin, Sạc pin, Dây đeo, Cataloge, Phiếu bảo hành', 3),
(45, 'Máy ảnh Fujifilm Instax Mini 11 Sky Blue/ Xanh', 1990000, 'https://kyma.vn/thumb/images/product/may-anh-fujifilm-instax-mini-11-sky-blue-xanh.jpg', '- Phim ảnh: Bộ phim tức thời mini Fujifilm INSTAX\n- Ảnh cỡ: 62mm x 46mm\n- Ống kính: 2 thành phần, 2 yếu tố, f = 60mm, 1: 12,7\n- Kính ngắm: Công cụ tìm hình ảnh thực, 0,37x, với vị trí mục tiêu\n- Màn trập: Màn trập điện tử được lập trình1 / 2 đến 1/250 giây. Synchro chậm cho ánh sáng yếu\n- Kiểm soát tiếp xúc: Tự động, Lv 5.0 đến 14,5 (ISO 800)', 3),
(46, 'Điện thoại Bphone 2021', 9790000, 'https://cdn.tgdd.vn/Products/Images/42/75001/bkav-bphone-2-hero-400x460.png', 'Bphone 2017 là chiếc smartphone thế hệ thứ 2 được nhà sản xuất Việt Nam Bkav trình làng với hàng loạt cải tiến vượt trội, tối ưu tốt nhất cho người Việt và giá bán rất tốt.', 1),
(47, 'Máy ảnh Canon EOS 6D Mark II Body', 34500000, 'https://kyma.vn/thumb/images/product/canon-eos-6d-mark-ii(2).jpg', '- Cảm biến kép: CMOS fullframe 26.2 megapixels\n- Bộ xử lý hình ảnh: DIGIC 7\n- Hệ thống đo nét tiên tiến với 45 điểm\n- Cảm biến đo sáng: IR + RGB 7560 pixel\n- Màn hình: LCD 3.0inch (cảm ứng)', 3),
(48, 'Máy ảnh Sony Cybershot DSC-W830/ Bạc', 3999000, 'https://kyma.vn/thumb/images/product/sony-cybershot-dsc-w830-may-anh-du-lich(1).jpg', '- Cảm biến: CCD 20.1 megapixels \n- Màn hình: 2.7inch \n- Zoom quang học 8x (25-200mm) Zoom số 32x\n- Khẩu độ: F/3.3 (W), F/6.3(T)\n- Độ nhạy sáng: ISO 80-3200\n- Tốc độ màn trập: 1 - 1/1600 giây\n- Tốc độ chụp: 0,8 ảnh/ giây ', 3),
(49, 'Laptop Apple Macbook Pro Touch MPTR2SA/A i7 2.8GHz/16GB/256GB (2017)', 59990000, 'https://cdn.tgdd.vn/Products/Images/44/158072/apple-macbook-pro-touch-mptr2sa-a-i7-28ghz-2017-450-3002-600x600.jpg', 'Nếu nhắc đến các siêu phẩm máy tính xách tay thì không thể bỏ qua được cái tên Apple - Macbook. Đặc biệt các sản phẩm thuộc dòng Pro như Macbook Pro Touch MPTR2SA/A i7 thì càng rất được nhiều người dùng quan tâm đến một chiếc laptop làm đồ hoạ tốt, làm việc mượt mà.', 2);
...
INSERT INTO `user` (`ID`, `email`, `password`, `phonenumber`) VALUES
(1, '[value-2]', '[value-3]', '[value-4]'),
(2, 'nkien2000@gmail.com', '123456', '0911152000'),
(3, 'admin@gmail.com', '1', '01234567891');
