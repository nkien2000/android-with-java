...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng uit = new LatLng(20.99470, 105.85412);
        mMap.addMarker(new MarkerOptions().position(uit).title("Trường Đại học Phương Đông").snippet("Ngõ Chùa Hưng Ký, Minh Khai, Hai Bà Trưng, Hà Nội .").icon(BitmapDescriptorFactory.defaultMarker()));
